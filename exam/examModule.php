...
<?php
	$con=new Config;
	$conn=$con->createCon();
	$sqlDate="SELECT DISTINCT `module` FROM `user_master` Order By module ASC";
    	...
    	<div class="row">
            ...
            <div class="col-sm-12">
				...
				<ul class="nav nav-pills">
					<li class="active">
                    	<a href="<?php echo 'getExamModule.php?module='.$rowDate['module']; ?>">
                    		<?php echo 'Module '.$rowDate['module']; ?>
                    	</a>
                    </li>
				</ul>
                </div>
