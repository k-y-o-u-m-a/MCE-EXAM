...
<?php
	$con=new Config;
	$conn=$con->createCon();
	$sqlDate="SELECT DISTINCT `exam_center_code` FROM `user_master` where `exam_center_code`!='' Order By module ASC";
...
<body>
	<div class="container">
    	<div class="row">
            ...
            <div class="col-sm-12">
            	<h3>Datewise Examination Result</h3>
				<?php
				...
				<ul class="nav nav-pills">
					<li class="active">
                    	<a href="<?php echo 'getExamCenter.php?center='.$rowDate['exam_center_code']; ?>">
                    		<?php echo $rowDate['exam_center_code']; ?>
                    	</a>
                    </li>
				</ul>
                </div>
