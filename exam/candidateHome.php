<?php
	...
	if(isset($_REQUEST['finish']))
	{
		...
		if(!isset($_SESSION['id']))
			...
			$fn="userlog/".$_REQUEST['regNo'].".csv";
			$myfile = fopen($fn, "a") or die("Unable to open file!");
			//$fn1="\\\\".$_SERVER['REMOTE_ADDR']."\\exam//".$_REQUEST['regNo'].".csv";
			//$myfileclient = fopen($fn1, "a") or die("Unable to open file!");

		for($i=0;$i<$_SESSION['total_que'];$i++)
		{
			if(isset($_REQUEST['userAns'.$i]))
			{
$sq="UPDATE `user_answer` SET user_ans='".$_REQUEST['userAns'.$i]."',right_answer='".$_REQUEST['correctAnswer'.$i]."' where session_id='".md5($_SESSION['id'])."' && que_id=".$_REQUEST['qId'.$i];
mysqli_query($conn,$sq);
			...
			if(isset($_REQUEST['userAns'.$i]))
			{
				...
				$txt=nl2br($txt);
				fwrite($myfile, $txt);
				//fwrite($myfileclient, $txt);
				
				echo $_REQUEST['userAns'.$i].$_REQUEST['correctAnswer'.$i];
				$totAttempt++;
    	...
    	<div class="row">
			...
			<div class="col-sm-12">
                ...
                <div class="col-sm-2">
					<ul class="pagination">
        				<li class="">
						<a href="javascript:void(0);">Roll No : <?php echo $_SESSION['regNo1'];?></a>
						</li>
					</ul>
				</div>
                <div class="col-sm-5">
                ...
                <div class="col-sm-3" align="left">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<ul class="pagination">
        				<li class="">
						<button type="button" id="finish1" class="btn btn-primary" name="finish1" value="" style="background-color:#009933;" onClick="finish_exam();">Finish Exam</button>
...
<?php
	...
	$sql="Select q.*,u.* from question q,user_answer u where q.module='".$_SESSION['module']."' && q.status='Y' && u.user_id='".$_SESSION['id']."' && u.que_id=q.qId Order by u.q_no ASC Limit ".$_SESSION['total_que']; // Question Module
	//echo $sql;
...
?>
            ...
            <div class="col-sm-12" style="font-size:17px;">
				 <b>A. </b><input type="radio" id="userAns1<?php echo $userAns; ?>" name="userAns<?php echo $userAns; ?>" value="A" <?php if($savedAns=='A') echo 'checked';?> onClick1="saveAns(<?php echo $userAns; ?>,this.value);">
				<?php echo $row['option1'];?>
                <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <?php echo $row['option1_hindi'];?>
            </div>
            <div class="col-sm-12" style="font-size:17px;">
				 <b>B. </b><input type="radio" id="userAns2<?php echo $userAns; ?>" name="userAns<?php echo $userAns; ?>" value="B" <?php if($savedAns=='B') echo 'checked';?> onClick1="saveAns(<?php echo $userAns; ?>,this.value);">
				<?php echo $row['option2'];?>
                <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <?php echo $row['option2_hindi'];?>
            </div>
            <div class="col-sm-12" style="font-size:17px;">
				 <b>C. </b><input type="radio" id="userAns3<?php echo $userAns; ?>" name="userAns<?php echo $userAns; ?>" value="C" <?php if($savedAns=='C') echo 'checked';?> onClick1="saveAns(<?php echo $userAns; ?>,this.value);">
				<?php echo $row['option3'];?>
                <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <?php echo $row['option3_hindi'];?>
            </div>
            <div class="col-sm-12" style="font-size:17px;">
				 <b>D. </b><input type="radio" id="userAns4<?php echo $userAns; ?>" name="userAns<?php echo $userAns; ?>" value="D" <?php if($savedAns=='D') echo 'checked';?> onClick1="saveAns(<?php echo $userAns; ?>,this.value);">
...
<button type="button" class="btn btn-primary" onClick="saveAns1(<?php echo $userAns; ?>,'userAns<?php echo $userAns; ?>');clickNext(<?php echo $i;?>,<?php echo $count;?>)"><b>Confirm</b></button>

          
<span style="margin-right:880px;">&nbsp;</span><button type="button" class="btn btn-primary" onClick="delAns(<?php echo $userAns; ?>,this.value);">Reset</button>
...
<input type="hidden" value="<?php echo $_SESSION['module'];?>" name="module">
		...
		<br/>
			...
			<a id="<?php echo 'label'.$j;?>" href="javascript:void(0);" style="text-align:center;width:25px;height:25px;padding:2px; color:#FFF; background-color:#F00;float:left;margin-right:5px;margin-bottom:2px;" onClick="gotoQue(<?php echo $j;?>,this.id);" >
							<?php echo $j; ?>
						</a>
...
<script type="text/javascript">
 ...
 //if(document.getElementById('timer').innerHTML=='Time Left : 0 Mins')
	...
	function setTime()
	{
		...
		if(tot == 0)
		{
			alert('Time is Over !!! Click Ok to finish your exam !!!');
	...
	function saveAns1(qNo,qValue1)
	{
		
		var qValue=0;	
		
		var ele = document.getElementsByName(qValue1);
			...
			{
				//ques_id=qNo+1;
				//rdocument.getElementById('label'+ques_id).style.background='#ffff00';
